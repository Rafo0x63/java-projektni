...
public class Administrator extends User {
    public Administrator(Long id, String name, String username, String password, Integer administrator) {
    ...
    public Administrator(Long id, String name, String username, Integer administrator) {
